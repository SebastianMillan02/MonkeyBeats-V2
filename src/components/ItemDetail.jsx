    ...
    <main>
      ...
      <section className="producto-individual">
        <div className="producto-individual__galeria">
          ...
          {[...Array(3)].map((_, i) => (
            <div className="producto-individual__galeria__thumbnail" key={i}>
              <img src={producto.img} alt={`Miniatura ${i + 1}`} />
            </div>
          ))}
        </div>
        ...
        <div className="producto-individual__main-container">
          <div className="producto-individual__details">
            <h5 className="producto-individual__details__subtitle">{producto.categoria}</h5>
            ...
            <p className="producto-individual__details__text">{producto.descripcion}</p>
            ...
            <div className="producto-carrito">
              <div className="producto-individual__details__buttons">
                <button className="producto-individual__button--primary">
                  Añadir al carrito
                </button>
              </div>
          ...
          <div className="producto-individual__details__cupon">
            ...
            <div className="cupon__box">
              ...
              <p className="cupon__box__text">usando el código: <strong>SAVEMONKEYS15</strong></p>
            </div>
          </div>
        </div>
      </section>
